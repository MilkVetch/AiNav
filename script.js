...
const I18N = {
    zh: {
        ...
        copyJsonBtn: "Copy Initial JSON", copySuccess: "已复制！"
    },
    en: {
...
function render() {
    ...
    board.categories.forEach((cat, cIdx) => {
        ...
        section.innerHTML = `<div style="display:flex; justify-content:space-between; margin-bottom:1rem; color:var(--text-dim)"><span>${cat.name}</span><button class="close-btn" style="font-size:0.8rem" onclick="deleteCat(${cIdx})"><i data-lucide="trash-2" class="arrow-icon"></i></button></div><div class="board-grid" id="cat-${cIdx}"></div>`;
